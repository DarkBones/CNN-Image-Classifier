...
class ImagePreprocessor:
    def __init__(self):
        ...
        self.clear = True # if true, data in training, test and validation directories will be deleted before splitting the data in the originals directory
    ...
    def __split_dataset(self):
        ...
        for category in os.listdir(self.originals_dir):
            ...
            validation_count = round(len(files) * self.val_size)
